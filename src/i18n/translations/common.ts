export const common = {
  ...
  es: {
    ...
    'ogImage.alt':
      'Ciudad de Girona al fondo (edificios, la Catedral, etc.) y delante el logo de GeeksCAT (celebro con las líneas de circuito) todo esto sobre un suleo que representa un circuito impreso',
  },
} as const;
